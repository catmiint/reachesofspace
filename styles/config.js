...
/* Your sheet ID
/* ------------------------------------------------------------------- */
let sheetID = "1g_zPog6yEcclgrDD0sJQSnZlu1l4gWxyyoOuUVMm2cQ";
...
let options = {
    ...
    masterlist: {
        ...
        searchFilterParams: ['ID', 'Name', 'Owner', 'Designer', 'Artist', 'Subspecies','Basics','Hoard','Gummi','Mutations', 'Status'],
